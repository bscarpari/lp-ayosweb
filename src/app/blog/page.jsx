...
export default async function Blog() {
  ...
  return (
    <>
      <PageIntro eyebrow="Blog" title="Últimas publicações">
        <p>
          Fique por dentro das últimas notícias, dicas e novidades do mundo da
          tecnologia que nos permeia e inspira.
        </p>
      </PageIntro>
