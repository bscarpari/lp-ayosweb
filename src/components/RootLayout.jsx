  ...
  return (
    <Container>
      <div className="flex items-center justify-between">
        ...
        >
          <svg height="40" width={84} viewBox="0 0 84 40" aria-hidden="true">
            <Logo className="sm:hidden" invert={invert} filled={logoHovered} />
            <Logomark
...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/work">Trabalhos</NavigationItem>
        <NavigationItem href="/about">Sobre nós</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/process">Processo</NavigationItem>
